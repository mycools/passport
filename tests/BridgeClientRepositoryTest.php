...
use Mycools\Passport\Bridge\ClientRepository;

class BridgeClientRepositoryTest extends TestCase
{
    public function setUp()
    {
        $clientModelRepository = Mockery::mock(Mycools\Passport\ClientRepository::class);
        ...
        $this->repository = new Mycools\Passport\Bridge\ClientRepository($clientModelRepository);
    }
    ...
    public function test_can_get_client_for_auth_code_grant()
    {
        ...
        $this->assertInstanceOf('Mycools\Passport\Bridge\Client', $client);
    ...
    public function test_can_get_client_for_client_credentials_grant()
    {
        ...
        $this->assertInstanceOf('Mycools\Passport\Bridge\Client', $this->repository->getClientEntity(1, 'client_credentials', 'secret', true));
    ...
    public function test_password_grant_is_permitted()
    {
        ...
        $this->assertInstanceOf('Mycools\Passport\Bridge\Client', $this->repository->getClientEntity(1, 'password', 'secret'));
    }
    ...
    {
        $this->assertInstanceOf('Mycools\Passport\Bridge\Client', $this->repository->getClientEntity(1, 'authorization_code', 'secret'));
    }
    ...
    public function test_personal_access_grant_is_permitted()
    {
        ...
        $this->assertInstanceOf('Mycools\Passport\Bridge\Client', $this->repository->getClientEntity(1, 'personal_access', 'secret'));
    }
    ...
    {
        $this->assertInstanceOf('Mycools\Passport\Bridge\Client', $this->repository->getClientEntity(1, 'client_credentials', 'secret'));
    }
