...
class TransientTokenControllerTest extends TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('Mycools\Passport\ApiTokenCookieFactory');
        ...
        $controller = new Mycools\Passport\Http\Controllers\TransientTokenController($cookieFactory);
