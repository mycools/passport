...
class ClientControllerTest extends TestCase
{
    ...
    public function test_all_the_clients_for_the_current_user_can_be_retrieved()
    {
        ...
        $controller = new Mycools\Passport\Http\Controllers\ClientController(
    ...
    public function test_clients_can_be_stored()
    {
        ...
        $clients->shouldReceive('create')->once()->with(1, 'client name', 'http://localhost')->andReturn($client = new Mycools\Passport\Client);
    ...
    {
        $clients = Mockery::mock('Mycools\Passport\ClientRepository');
        $client = Mockery::mock('Mycools\Passport\Client');
        ...
        $clients->shouldReceive('update')->once()->with(
            Mockery::type('Mycools\Passport\Client'), 'client name', 'http://localhost'
        )->andReturn('response');
    ...
    public function test_clients_can_be_deleted()
    {
        ...
        $clients->shouldReceive('delete')->once()->with(
            Mockery::type('Mycools\Passport\Client')
        )->andReturn('response');
