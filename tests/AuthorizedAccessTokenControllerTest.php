...
use Mycools\Passport\Client;
use PHPUnit\Framework\TestCase;
use Mycools\Passport\TokenRepository;
use Mycools\Passport\Http\Controllers\AuthorizedAccessTokenController;
...
class AuthorizedAccessTokenControllerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->controller = new Mycools\Passport\Http\Controllers\AuthorizedAccessTokenController(
    ...
    public function test_tokens_can_be_retrieved_for_users()
    {
        ...
        $token1 = new Mycools\Passport\Token;
        $token2 = new Mycools\Passport\Token;
    ...
    public function test_tokens_can_be_deleted()
    {
        ...
        $token1 = Mockery::mock(Mycools\Passport\Token::class.'[revoke]');
        $token1->id = 1;
