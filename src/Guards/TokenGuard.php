...
namespace Mycools\Passport\Guards;
...
use Mycools\Passport\TransientToken;
...
class TokenGuard
{
     ...
     *
     * @var \Mycools\Passport\TokenRepository
     */
    protected $tokens;
     ...
     *
     * @var \Mycools\Passport\ClientRepository
     */
    protected $clients;
     ...
     * @param  \Mycools\Passport\TokenRepository  $tokens
